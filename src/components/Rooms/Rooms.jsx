    ...
    <section className='md:px-[120px] overflow-hidden  mx-auto px-12 pb-8  '>
      ...
      <div className='flex flex-col md:flex-row gap-7'>
        ...
        <motion.div
          ...
          <img src={r1} className='!h-[350px] rounded-4xl mb-3' loading='lazy' alt="" />
          ...
          <span className='text-center px-9 py-3  text-mowana !border !border-mowana hover:bg-mowana-light hover:text-white duration-200 cursor-pointer mt-3 w-10/12 mx-auto  ' >See More</span>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: .5 }}
          className='lg:w-3/12 flex  flex-col font-[poppins] '>
          <img src={r2} className='!h-[350px] rounded-4xl mb-3' loading='lazy' alt="" />
        ...
        <motion.div
          ...
          transition={{ duration: .5 }}
          className='lg:w-3/12 flex  flex-col font-[poppins] '>
          <img src={r3} className='!h-[350px] rounded-4xl mb-3' loading='lazy' alt="" />
        ...
        <motion.div
          ...
          transition={{ duration: .5 }}
          className='lg:w-3/12 flex  flex-col font-[poppins] '>
          <img src={r4} className='!h-[350px] rounded-4xl mb-3' loading='lazy' alt="" />
